...
export default function IesdaFloatingCTA() {
      ...
      {visible && (
        ...
        >
          ...
          <Link
            ...
            className="w-12 h-12 bg-[#25D366] hover:bg-[#20bb5c] text-white rounded-full shadow-xl flex items-center justify-center transition-transform hover:scale-110"
          >
          ...
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #2A2118 0%, #D7A22A 100%)",
              boxShadow: "0 4px 20px rgba(215,162,42,0.4)",
            }}
          >
