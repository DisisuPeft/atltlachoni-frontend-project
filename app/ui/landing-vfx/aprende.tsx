...
const ITEMS = [
  ...
  },
  {
    ...
    title: "Efectos Visuales para Cine",
    color: "#18C62A",
  },
  {
    icon: (
  ...
  },
  {
    ...
    title: "Proyecto Final & Reel",
    color: "#6C3DFF",
  },
];

export function VfxAprende() {
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <p className="mt-4 max-w-xl mx-auto text-base" style={{ color: "#A0A0A0" }}>
            Cada habilidad se desarrolla con proyectos prácticos usando el mismo
            software que utilizan los estudios de Hollywood.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {ITEMS.map((item, i) => (
            <motion.div
              ...
              className="group flex items-center gap-4 p-5 rounded-2xl transition-all duration-300 hover:scale-[1.01]"
              style={{
            ...
            >
              ...
              <div
                className="ml-auto w-0 group-hover:w-6 h-px transition-all duration-300 shrink-0"
