...
export function IconPlayCircle({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-3.172M9.497 14.25a7.454 7.454 0 00.981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 007.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.41 9.71 2.25 12 2.25c2.291 0 4.545.16 6.75.47v1.516M18.75 4.236c.982.143 1.954.317 2.916.52A6.003 6.003 0 0116.27 9.728M18.75 4.236V4.5c0 2.108-.966 3.99-2.48 5.228M16.27 9.728l-.855.855m0 0a7.468 7.468 0 01-.987 3.172m1.842-4.027a7.468 7.468 0 00-3.59-.96m0 0a7.468 7.468 0 00-3.592.96M7.73 9.728l.855.855m0 0a7.468 7.468 0 00-.987 3.172M8.586 10.583a7.468 7.468 0 013.591-.96"
      />
    </svg>
  );
}

export function IconWidget({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function IconCalendarEnd({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
